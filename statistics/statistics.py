...
def check_statistics(scenario: int, count: int):
	...
	a_min_time = None	# Minimal working time for A*
	b_max_time = 0		# Maximum working time for Backtracking
	a_max_time = 0		# Maximum working time for A*
	b_time = None	    # Working time for Backtracking
	a_time = None	    # Working time for A*

	b_min_steps = None	# Minimal number of steps for Backtracking
    a_min_steps = None	# Minimal number of steps for A*
    b_max_steps = 0		# Maximum number of steps for Backtracking
    a_max_steps = 0		# Maximum number of steps for A*
    b_steps = None	    # Number of steps for Backtracking
    a_steps = None	    # Number of steps for A*
